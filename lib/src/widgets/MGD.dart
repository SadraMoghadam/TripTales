...
typedef CustomMatrixGestureDetectorCallback = void Function(
    Matrix4 matrix,
...
/// parameters.
///
class CustomMatrixGestureDetector extends StatefulWidget {
  /// [Matrix4] change notification callback
  ///
  final CustomMatrixGestureDetectorCallback onMatrixUpdate;
  ...
  late GestureLongPressEndCallback? onLongPressEnd;
  ...
  @override
  _CustomMatrixGestureDetectorState createState() => _CustomMatrixGestureDetectorState();
...
class _CustomMatrixGestureDetectorState extends State<CustomMatrixGestureDetector> {
