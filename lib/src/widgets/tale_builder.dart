        ...
        height: device.height * 10,
          ...
          child: DynamicStack(
            ...
            //   MemoryCard(cardKey: _widgetKeyList[i], type: MemoryCardType.image,)
                ...
                MemoryCard(cardKey: _widgetKeyList[1], type: MemoryCardType.image, imagePath: "assets/images/london_tale.jpg", size: Size(100, 100),),
                MemoryCard(cardKey: _widgetKeyList[0], type: MemoryCardType.image, imagePath: "assets/images/winter_tale.jpg", size: Size(300, 300)),
                MemoryCard(cardKey: _widgetKeyList[2], type: MemoryCardType.video, size: Size(200, 200)),
