...
//  });
  ...
  testWidgets('Test buildHome widget', (WidgetTester tester) async {
  ...
  testWidgets('Test buildHome widget 3', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: Builder(
          builder: (BuildContext context) {
  ...
  testWidgets('Test buildHome widget 2', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: Builder(
          builder: (BuildContext context) {
